...
pub const SEGMENT_FLAGS_NONE: u64 = 0; /* Writable */
pub const SEGMENT_FLAGS_WRITE: u64 = 1 << 0; /* Writable */
pub const SEGMENT_FLAGS_ALLOC: u64 = 1 << 1; /* Occupies memory during execution */
pub const SEGMENT_FLAGS_EXECINSTR: u64 = 1 << 2; /* Executable */
pub const SEGMENT_FLAGS_MERGE: u64 = 1 << 4; /* Might be merged */
pub const SEGMENT_FLAGS_STRINGS: u64 = 1 << 5; /* Contains nul-terminated strings */
pub const SEGMENT_FLAGS_INFO_LINK: u64 = 1 << 6; /* `sh_info' contains SHT index */
pub const SEGMENT_FLAGS_LINK_ORDER: u64 = 1 << 7; /* Preserve order after combining */
